...
var preguntas_schema = new Schema({
...
var Pregunta = mongoose.model('Pregunta', preguntas_schema);
var listapreguntas;
module.exports = Pregunta;

// Conectar a mongodb
var url ='mongodb://jesus:jesus@ds245478.mlab.com:45478/juego';
...
io.on('connection', function(socket){
    ...
    socket.on("nuevo_usuario", function(user){
      ...
      socket.on('empezar_partida', function(nada){
        pregunta = 0;
        io.emit('datos_juego', listapreguntas[pregunta]);
        pregunta++;
      })
